    ...
    <footer className="bg-black text-white rounded-t-xl">
      <div className="bottom-0 w-full flex flex-col md:flex-row px-8 py-8 md:px-14 md:py-14 ">
        <div className="max-w-[350px] md:mr-20 lg:mr-28 mb-10">
          <h2 className="uppercase adca-font font-bold m-0">We&#39;ll Keep you posted</h2>
          ...
          <input
            ...
            className="p-5 pr-[120px] text-lg rounded-md border-0 w-full"
          />
        ...
        <div className="flex justify-between md:max-w-[600px] max-w-[450px]">
          <div>
            <h5 className="uppercase adca-font md:text-lg font-bold m-0">General</h5>
          ...
          <div className="mx-4 lg:mx-[100px]">
            <h5 className="uppercase adca-font md:text-lg font-bold m-0">Initiatives</h5>
          ...
          <div>
            <h5 className="whitespace-nowrap adca-font uppercase md:text-lg font-bold m-0">
              Social Media
            </h5>
            <ul className="list-none p-0 text-[#FB8E5B] text-sm md:text-lg">
              <li>Linkedin</li>
